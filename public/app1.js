...
// EX_DB liegt seit der Server-Geldbörse in exdb.js (wird vor app1.js geladen)
...
function finalizeEndWorkout(autoCommitted){
  ...
  // XP erst NACH dem Speichern, nur für echte Workouts. Der Server prüft gegen das
  // gespeicherte Datum und schreibt pro Tag nur einmal gut (wallet.js → earnReward).
  if(exCount > 0 && typeof earnReward === 'function'){
    try{ earnReward('workout', woDate, {label:'Workout abgeschlossen'}); }catch(e){}
  }
