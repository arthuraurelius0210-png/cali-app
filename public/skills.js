...
function buildSkillUI(){
  ...
  for(var si=0;si<SKILLS.length;si++){
    ...
    pe.style.cssText='font-family:inherit;font-weight:800;font-size:17px;color:'+(allDone?skill.color:'var(--muted)')+';white-space:nowrap;text-align:right;';
    ...
    for(var k=0;k<skill.steps.length;k++){
      ...
      circle.style.cssText='width:26px;height:26px;border-radius:50%;flex-shrink:0;margin-top:1px;display:flex;align-items:center;justify-content:center;font-family:inherit;font-weight:800;font-size:13px;';
      ...
      if(isNext){
        ...
        nb.style.cssText='display:inline-block;background:'+skill.color+';color:#fff;font-size:9px;font-weight:800;padding:2px 8px;border-radius:20px;margin-top:5px;';
